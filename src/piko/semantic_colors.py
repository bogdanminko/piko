...
_ENTRIES: list[tuple[tuple[str, ...], str, str]] = [
    ...
    (("blue", "синий", "синяя", "синее", "синие", "синего",
      "синему", "синим", "синих", "синем"), "#0A84FF", "\U0001f535"),  # 🔵
    ...
    (("white", "белый", "белая", "белое", "белые", "белого",
      "белой", "белым", "белых"), "#FFFFFF", "⚪"),          # ⚪
    (("gray", "grey", "серый", "серая", "серое", "серые",
      "серого", "серой", "серым", "серых"), "#8E8E93", "⚫"),
    (("gold", "golden", "золот"), "#FFD700", "\U0001f947"),      # 🥇
    (("silver", "серебр"), "#C7C7CC", "\U0001f948"),             # 🥈
    # --- Color-associated objects ---
    (("fire", "flame", "огонь", "огня", "огне", "огнём", "пламя"),
     "#FF6B35", "\U0001f525"),                                   # 🔥
    (("water", "вода", "воды", "воду", "воде", "водой"),
     "#339CFF", "\U0001f4a7"),                                   # 💧
    (("sun", "sunny", "солнц"), "#FFD60A", "☀️"),      # ☀️
    (("ice", "frozen", "холод", "лёд", "льда", "льду", "мороз"),
     "#7DD8FF", "\U0001f9ca"),                                   # 🧊
    (("love", "любовь", "любви", "любят", "люблю"),
     "#FF3B5C", "❤️"),                                 # ❤️
    (("money", "cash", "деньги", "денег", "деньгам", "бабки", "бабок"),
     "#34C759", "\U0001f4b0"),                                   # 💰
    # --- Growth / decline (finance-talk accent) ---
    (("grow", "growth", "growing", "profit", "рост", "раст",
      "выросл", "прибыл"), "#34C759", "\U0001f4c8"),             # 📈
    (("crash", "drop", "loss", "падени", "упал", "упало", "упали",
      "обвал", "убыт"), "#FF3B30", "\U0001f4c9"),                # 📉
]
